...
%  $Revision: 1.57.4.11 $ $Date: 2006/03/10 01:53:23 $
...
[WrapString,NewMsgTxtPos]=textwrap(MsgHandle,BodyTextString,175);
delete(MsgHandle);
...
set(0,'Units','pixels');
DefFigPos(1) = monsize(3)/2-DefFigPos(3)/2;
DefFigPos(2) = monsize(4)/2-DefFigPos(4)/2;
...
txtPos = [ MsgTxtXOffset MsgTxtYOffset+5 0 ];
text( ...
    'Parent'              ,AxesHandle                        , ...
    'Units'               ,'points'                          , ...
